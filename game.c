...
/*   Updated: 2024/10/18 13:08:54 by mailinci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int game_start(t_mlx game)
{
    ...
    game.img.tiles = mlx_xpm_file_to_image(game.data, "img/tiles.xpm", &w, &h);
    game.img.wall = mlx_xpm_file_to_image(game.data, "img/wall.xpm", &w, &h);
    game.img.paper = mlx_xpm_file_to_image(game.data, "img/paper.xpm", &w, &h);
    game.img.toilet[0] = mlx_xpm_file_to_image(game.data, "img/toilet_closed.xpm", &w, &h);
    game.img.toilet[1] = mlx_xpm_file_to_image(game.data, "img/toilet_open.xpm", &w, &h);
    game.img.poopie = mlx_xpm_file_to_image(game.data, "img/poopie.xpm", &w, &h);
	render(&game); //put image
